# Available .MOE One-Word Domains (5,622,488)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C868%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C488%20domains-6f42c1">
...
> **Important:** this repository is a **public 8,868-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,488 domains** on the canonical page below.

**Public extract:** 8,868 rows · **Live catalog:** 5,622,488 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/moe?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_moe_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/moe?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_moe_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./moe.csv">CSV</a> / <a href="./moe.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_moe_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_moe_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .MOE search](https://unique.domains/domains/tld/moe?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_moe_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .MOE search](https://unique.domains/domains/tld/moe?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_moe_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./moe.csv) or [Download JSON](./moe.json)
...
- `moe.csv` — public CSV extract (8,868 rows)
- `moe.json` — public JSON extract (8,868 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,868-row public sample | 5,622,488 live domains                           |
...
| power.moe      | premium   | $104      | $15.60        | 98             | 64     | 5      | namecheap        |
...
| genius.moe     | available | $17.88    | —             | 98             | 47     | 6      | namecheap        |
| business.moe   | premium   | $104      | $15.60        | 100            | 54     | 8      | namecheap        |
...
| agile.moe      | available | $17.88    | —             | 92             | 42     | 5      | namecheap        |
...
> Unique Domains. *Available .MOE One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
